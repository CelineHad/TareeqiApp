...
public class CustomersMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener {
    ...
    private Button PlaceCustomerButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlaceCustomerButton=findViewById(R.id.customer_places_btn);
        ...
        FirebaseDatabase.getInstance().getReference().child("Drivers Available").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){available=true;}
            }
        ...
        callCabcarbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (available) {
                    ...
                    Toast.makeText(CustomersMapActivity.this, "no available drivers right now....please try later", Toast.LENGTH_SHORT).show();
                }
        ...
        PlaceCustomerButton.setOnClickListener(new View.OnClickListener() {//-------------------------------------------------------------
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CustomersMapActivity.this,placesActivity.class);
                intent.putExtra("type","Customers");
                startActivity(intent);
            }
        });
