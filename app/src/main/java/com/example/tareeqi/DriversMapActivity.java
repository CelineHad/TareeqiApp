...
public class DriversMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener {
    ...
    private Button PlaceDriverButton;
...
// data----------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlaceDriverButton=findViewById(R.id.driver_places_btn);
        ...
        PlaceDriverButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DriversMapActivity.this,placesActivity.class);
                intent.putExtra("type","Drivers");
                startActivity(intent);
