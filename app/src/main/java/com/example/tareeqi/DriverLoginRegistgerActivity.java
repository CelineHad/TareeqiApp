...
public class DriverLoginRegistgerActivity extends AppCompatActivity {
    ...
    private EditText PasswordDriver2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PasswordDriver2=findViewById(R.id.password_driver2);
        DriverBar=findViewById(R.id.driver_bar);
        PasswordDriver2.setVisibility(View.INVISIBLE);
        ...
        DriverRegisterLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PasswordDriver2.setVisibility(View.VISIBLE);
            ...
            mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        Intent driverIntent=new Intent(DriverLoginRegistgerActivity.this, DriversMapActivity.class);
                    ...
                    else
                    {
                        ...
                        Intent intent=new Intent(DriverLoginRegistgerActivity.this,DriversMapActivity.class);
    ...
    private void RegisterDriver(String email, String password) {
        ...
        if(!PasswordDriver2.equals(PasswordDriver)){
            Toast.makeText(DriverLoginRegistgerActivity.this,"Password does not match...",Toast.LENGTH_SHORT).show();
        }
        else
        {
            DriverBar.setVisibility(View.VISIBLE);
